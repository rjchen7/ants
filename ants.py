...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        count = 0
        while current_place != beehive and count <= self.max_range:
            if random_or_none(current_place.bees) and count >= self.min_range:
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        return self.contained_ant == None and not hasattr(other, "contained_ant")
        # END Problem 9
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        if self.true_queen:
            ...
            while next_exit != None:
                if next_exit.ant != None:
                    if hasattr(next_exit.ant, "damage") and not next_exit.ant.doubled:
                        next_exit.ant.damage = next_exit.ant.damage * 2
                        next_exit.ant.doubled = True
                    if hasattr(next_exit.ant, "contained_ant"):
                        if next_exit.ant.contained_ant != None and hasattr(next_exit.ant.contained_ant, "damage") and not next_exit.ant.contained_ant.doubled:
                            next_exit.ant.contained_ant.damage = next_exit.ant.contained_ant.damage * 2
                            next_exit.ant.contained_ant.doubled = True
...
class Bee(Insect):
    ...
    def __init__(self, armor):
        self.direction = True  # going left is True, going right is False
